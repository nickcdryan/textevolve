...
def schedule_meeting(constraints, max_attempts=3):
    ...
    Existing Schedules: Alice - None, Bob - Tuesday 10:00-11:00, Carol - None
    Preferences: Carol - before noon
    Reasoning: Alice and Carol are free all day. Bob is busy 10:00 to 11:00. Carol would prefer to meet before noon. Available slots include 9:00-9:45, 9:15-10:00, etc. Selecting 9:00 - 9:45 fulfills Carol's preference and avoids Bob's meeting.
