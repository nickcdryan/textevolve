...
def extract_transformation_rules(question):
    ...
    """
    return mock_llm(prompt, system_instruction)
...
def verify_transformation_rules(question, rules):
    ...
    verification_result = mock_llm(prompt, system_instruction)
...
def mock_llm(prompt, system_instruction):
    return "Valid"
