...
def extract_constraints(question, max_attempts=3):
    ...
    Explicitly mention if a participant has no meetings or is free all day.
    ...
    Existing Schedules: John - Free all day, Jennifer - Monday 9:00-11:00
...
def schedule_meeting(constraints, max_attempts=3):
    ...
    system_instruction = "You are an expert at scheduling meetings, finding the best possible time while respecting preferences. Provide detailed reasoning and be exhaustive in your search."
    ...
    Existing Schedules: Alice - Free all day, Bob - Tuesday 10:00-11:00, Carol - Free all day
    Preferences: Carol - before noon
    Reasoning: Alice and Carol are free all day. Bob is busy 10:00 to 11:00. Carol would prefer to meet before noon. Exhaustively checking: 9:00-9:45, 9:15-10:00, 9:30-10:15, 9:45-10:30, 10:00-10:45 all work. Selecting 9:00 - 9:45 fulfills Carol's preference and avoids Bob's meeting.
...
def verify_schedule(constraints, schedule, max_attempts=3):
    ...
    system_instruction = "You are a meeting schedule verifier. Provide detailed, step-by-step reasoning for INVALID schedules. Be specific about which constraint is violated. Be exhaustive in checking all constraints."
